...
templates = {'func': data_dir + '/sub-{subject_id}/ses-2/func/sub-{subject_id}_ses-2_task-Memory_space-MNI152NLin2009cAsym_desc-preproc_bold.nii.gz',
             'mask': data_dir + '/sub-{subject_id}/ses-2/func/sub-{subject_id}_ses-2_task-Memory_space-MNI152NLin2009cAsym_desc-brain_mask.nii.gz',
             'regressors': data_dir + '/sub-{subject_id}/ses-2/func/sub-{subject_id}_ses-2_task-Memory_desc-confounds_regressors.tsv',
             'events': '/media/Data/PTSD_KPE/condition_files/withNumbers/sub-{subject_id}_ses-2.csv'}
...
#%%
modelfit = pe.Workflow(name='modelfit_ses2', base_dir= output_dir)
"""
