...
import os
#%% data info
data_dir = os.path.abspath('/media/Data/KPE_fmriPrep_preproc/kpeOutput/fmriprep')
...
templates = {'func': '/media/Data/KPE_fmriPrep_preproc/kpeOutput/fmriprep/sub-{subject_id}/ses-1/func/sub-{subject_id}_ses-1_task-Memory_space-MNI152NLin2009cAsym_desc-preproc_bold.nii.gz',
             'mask': '/media/Data/KPE_fmriPrep_preproc/kpeOutput/fmriprep/sub-{subject_id}/ses-1/func/sub-{subject_id}_ses-1_task-Memory_space-MNI152NLin2009cAsym_desc-brain_mask.nii.gz',
             'regressors': '/media/Data/KPE_fmriPrep_preproc/kpeOutput/fmriprep/sub-{subject_id}/ses-1/func/sub-{subject_id}_ses-1_task-Memory_desc-confounds_regressors.tsv',
...
workflow = pe.Workflow(name='firstLevelKPE',base_dir="/media/Data/work")
