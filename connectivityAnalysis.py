...
#session1 = list(np.load('session_2Timeseries.npy', allow_pickle = True)) # loading the saved array
...
# plot in connectome
plotting.plot_connectome(correlation_Trauma_0_Mean_thr, coords, edge_threshold='95%', colorbar=True, black_bg = True, annotate = True)

##
plotting.plot_matrix(correlation_positive, labels=atlas_labes[:,0], colorbar=True, tri = 'diag', grid = 'color')
